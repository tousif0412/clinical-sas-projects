...
data ae(LABEL='Adverse Event'); set ae7; run;
      
/* Save Final AE Dataset to Output Folder */

libname Output '/home/u63981529/AE_SDTM/Output';
run;
...
proc export data=Output.AE
    outfile="/home/u63981529/AE_SDTM/Output/AE_final.csv"
    dbms=csv
    replace;
run;
